...
object configuracion{
	...
	const avionJp1 = new Avion(rangoMaximoMovimiento = 2, image = "avionDerechajugador1.png", position = game.at(0,5), vida = 100, ataques = [new Bombardeo(potencia = 30)])
    ...
    const tanqueJp1 = new Tanque(rangoMaximoMovimiento = 2, image = "tanqueDerechajugador1.png", position = game.at(0,4), vida = 250, ataques = [new Rifle(potencia = 100, rangoMaximo = 2)])
	...
	const avionJp2 = new Avion(rangoMaximoMovimiento = 2, image = "avionIzquierdajugador2.png", position = game.at(13,5), vida = 100, ataques = [new Bombardeo(potencia = 30)])
	const tanqueJp2 = new Tanque(rangoMaximoMovimiento = 2, image = "tanqueIzquierdajugador2.png", position = game.at(13,4), vida = 250, ataques = [new Rifle(potencia = 100, rangoMaximo = 2)])

	// Lista de las Unidades
	const unidades = [soldadoJp1, avionJp1, healerJp1, tanqueJp1, edificio1, edificio2, edificio3, soldadoJp2, healerJp2, avionJp2, tanqueJp2] 
